...
from backend.stock_fetcher import fetch_stock_data
...
class TestStockFetcher(unittest.TestCase):
    def test_fetch_stock_data(self):
        ...
        self.assertIn('symbol', result)      # Check if 'symbol' is in the result
        self.assertEqual(result['symbol'], 'AAPL')  # Check if the symbol matches
